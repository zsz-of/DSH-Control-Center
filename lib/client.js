    ...
    function RulesSection({ state, act, busy, error, scope, workspace }) {
      ...
      return h(
        ...
        h(
          ...
          dir === '' ? null : h(Button, { variant: 'outline', icon: h(IconFolderOpenOutline16, { size: 14 }), onClick: () => reveal({ dir }, act) }, '打开目录'),
        ),
        h(
          'div',
          { className: 'dcc-stat' },
    ...
    function SkillsTab({ state, act, busy, error }) {
      ...
      return h(
        ...
        h(
          ...
          h(Button, { variant: 'outline', icon: h(IconRefreshOutline16, { size: 14 }), onClick: () => act.refresh() }, '刷新'),
          h(Button, { variant: 'outline', icon: h(IconFolderOpenOutline16, { size: 14 }), onClick: () => reveal({ dir: state.paths.skills }, act) }, '打开目录'),
        ),
        h(
          'div',
          { className: 'dcc-stat' },
    ...
    function BackupTab({ state, act, error }) {
      ...
      return h(
        ...
        h(
          ...
          h(Button, { variant: 'outline', icon: h(IconFolderOpenOutline16, { size: 14 }), onClick: () => reveal({ dir: state.backup.dir }, act) }, '打开备份目录'),
